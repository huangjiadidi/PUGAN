...
parser.add_argument('--input_folder', default='cat_big_big', help='input folder')
parser.add_argument('--output_folder', default='output/outputlosses', help='output folder')
...
parser.add_argument('--gen_every', type=int, default=10000, help='Generate additional images with random fake cats every x iterations. Used in calculating FID.')
parser.add_argument('--extra_folder', default='output', help='Folder for extra photos (different so that my dropbox does not get overwhelmed with 50k pictures)')
...
parser.add_argument('--print_every', type=int, default=100, help='Generate a mini-batch of images at every x iterations (to see how the training progress, you can do it often).')
